...
import com.kadar.image.awsImageHandler.FileUtils;
import com.kadar.image.awsImageHandler.Image;
import com.kadar.image.awsImageHandler.ImageConverter;
import com.kadar.image.awsImageHandler.ImageDBHandler;
...
public class ImageConvertService implements ImageConvertServiceRemote{
    ...
    */
	...
	public void generateThumbnail(String bucketName, String key) throws IOException{
		ImageDBHandler imagedbhandler = new ImageDBHandler();
