...
import com.kadar.image.awsImageHandler.TaskMessage.Builder;
...
public class StatisticMessage {
	...
	public static class Builder{
		...
		*/
		...
		public Builder WhatAbout(String val){
			WhatAbout = val; return this;
		}
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((WhatAbout == null) ? 0 : WhatAbout.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		StatisticMessage other = (StatisticMessage) obj;
		if (Body == null) {
			if (other.Body != null)
				return false;
		...
		if (Value == null) {
			...
			return false;
		if (WhatAbout == null) {
			if (other.WhatAbout != null)
				return false;
		} else if (!WhatAbout.equals(other.WhatAbout))
			return false;
		return true;
	}
	...
	public String toString() {
		return "StatisticMessage [WhatAbout=" + WhatAbout + ", Value=" + Value
