...
public class ScalableApplication implements Scalable {
	...
	private QueueMessageHandler statisticservice;
	private ImageConvertServiceRemote convertservice;
	
	public ScalableApplication(QueueMessageHandler mservice, ImageConvertServiceRemote cservice){
		messageservice = mservice;
		this.convertservice = cservice;
		
		try{
			this.statisticservice = new QueueMessageHandler("default-statistic-queue");
