...
public class DBImageHandler implements Serializable{

	private static final long serialVersionUID = 1L;

	private AmazonSimpleDB sdb;

	public DBImageHandler() throws IOException{
	...
	public DBImageHandler(String name) throws IOException{
        sdb = new AmazonSimpleDBClient(new PropertiesCredentials(
        	getClass().getClassLoader().getResourceAsStream(name)));		
	}
	public DBImageHandler(AWSCredentials credentials) {
